package sistemadevantas.appweb.controllers;
...
import sistemadeventas.accesoadatos.ClienteDAL;
import sistemasdeventa.entiidadesdenegicios.Cliente;
import sistemadeventas.appweb.utils.*;
@WebServlet(name = "ClienteServlet", urlPatterns = {"/Cliente"})
public class ClienteServlet extends HttpServlet {
    private Cliente obtenerCategoria(HttpServletRequest request) {
     ...
     private void doGetRequestIndex(HttpServletRequest request, HttpServletResponse response, Object clientes) throws ServletException, IOException {
        try {
            Cliente cliente = new Cliente();
     ...
     private void doPostRequestIndex(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            request.setAttribute("roles", clientes);
            request.setAttribute("top_aux", cliente.getTop_aux());
            request.getRequestDispatcher("Views/Cliente/index.jsp").forward(request, response);
        } catch (Exception ex) { 
            Utilidad.enviarError(ex.getMessage(), request, response);
